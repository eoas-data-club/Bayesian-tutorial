...
*Question*: Draw the Bayesian network of this model, and write out the mathematical probability statement. For priors, use normal(0, 10) on mean abundance the salinity effect.
```{r Try it - data}
...
fm.ticks <- jags(
  data = datList.ticks,
  model.file = tick.mod,
  parameters.to.save = c('alpha0', 'b1', 'b2', 'b3', 'sig.site'),
  n.chains = 3,
  n.iter = 20000,
  n.burnin = 5000,
  n.thin = 3
...
```{r Try it - results}
plotPost(fm.ticks.dat$b1)
plotPost(fm.ticks.dat$b2)
plotPost(fm.ticks.dat$b3)
```
